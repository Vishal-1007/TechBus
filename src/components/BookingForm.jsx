...
import defaultBg from '../assets/images/cabc.jpg';
...
const BookingForm = ({ transportType, setTransportType }) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${transportType ? backgroundImages[transportType] : defaultBg})`,
